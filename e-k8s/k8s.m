...
s1.img.log: e-aws/s1/Dockerfile e-aws/s1/app.py
	$(DK) build -t overcoil/cmpt756s1:latest e-aws/s1 | tee s1.img.log
...
s2.img.log: e-aws/s2/Dockerfile e-aws/s2/app.py
	$(DK) build -t overcoil/cmpt756s2:latest e-aws/s2 | tee s2.img.log
...
db.img.log: e-aws/db/Dockerfile e-aws/db/app.py
	$(DK) build -t overcoil/cmpt756db:latest e-aws/db | tee db.img.log
